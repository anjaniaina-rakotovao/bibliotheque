            ...
            <% List<AdherentEntity> adherents = (List<AdherentEntity>) request.getAttribute("listAdherent");
                    List<PretEntity> pretsEnCours = (List<PretEntity>) request.getAttribute("pretsEnCours");
                            ...
                            <head>
                                ...
                                <title>Retour de Prêt - Bibliothèque</title>
                                <style>
                                    /* Reset et base */
                                    * {
                                        margin: 0;
                                ...
                                <nav class="navbar">
                                    <div class="nav-container">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="createReservation" class="nav-link">Faire un reservation</a>
                                            </li>
                                        ...
                                        <% if (request.getAttribute("messageSuccess") !=null) { %>
                                            ...
                                            <% } else if (request.getAttribute("messageError") !=null) { %>
                                                ...
                                                <% } %>
                                                    ...
                                                    <form action="retour" method="post" class="form-inline">
                                                            ...
                                                            <select name="idAdherent" id="idAdherent"
                                                                ...
                                                                <% for (AdherentEntity a : adherents) { %>
                                                                    <option value="<%= a.getIdAdherent() %>"
                                                                        <%=(idAdherentSelectionne !=null &&
                                                                        idAdherentSelectionne.equals(a.getIdAdherent()))
                                                                        ? "selected" : "" %>>
                                                                        <%= a.getAdherentName() %>
                                                                    </option>
                                                                    <% } %>
                                        ...
                                        <div class="card">
                                            <div class="pret-list">
                                                ...
                                                <form action="confirmerRetour" method="post">
                                                    <div class="form-group">
                                                        <label for="idPret">Sélectionner le prêt à retourner</label>
                                                        <select name="idPret" id="idPret" class="form-control" required>
                                                    ...
                                                    <button type="submit" class="btn btn-success">Confirmer le
                                                        retour</button>
                                                </form>
                                            </div>
                                        </div>
