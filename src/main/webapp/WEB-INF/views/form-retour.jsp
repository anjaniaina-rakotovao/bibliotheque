        ...
        <div class="card">
            ...
            <form action="retour" method="post" class="form-inline">
                <div class="form-group">
                    ...
                    <select name="idAdherent" id="idAdherent" class="form-control" required>
                ...
                <button type="submit" class="btn btn-primary">Afficher les prêts</button>
            </form>
        </div>
                            ...
                            <select name="idPret" id="idPret" class="form-control" required>
                                ...
                                <% for (PretEntity p : pretsEnCours) { %>
                                    <option value="<%= p.getIdPret() %>">
                                        📖 <%= p.getExemplaire().getLivre().getTitre() %> | 📅 Emprunté le : <%= p.getDatePret() %>
                                    </option>
                                <% } %>
                            </select>
                        </div>
