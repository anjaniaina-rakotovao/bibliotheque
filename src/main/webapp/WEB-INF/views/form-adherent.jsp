                            ...
                            <div class="card">
                                ...
                                <form action="creationAdherent" method="post">
                                    <div class="form-group">
                                        <label for="adherentname">Nom complet</label>
                                        <input type="text" id="adherentname" name="adherentname" class="form-control"
                                            required>
                                    </div>

                                    <div class="form-group">
                                        <label for="profilType">Type de profil</label>
                                        <select name="profilType" id="profilType" class="form-control" required>
                                            <option value="">-- Sélectionner un profil --</option>
                                            <% for (ProfilEntity tag : tags) { %>
                                                <option value="<%= tag.getIdProfil() %>">
                                                    <%= tag.getProfilType() %>
                                                </option>
                                                <% } %>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label for="datecreation">Date de création du compte</label>
