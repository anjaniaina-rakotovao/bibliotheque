            ...
            <%@ page import="entities.AdherentEntity" %>
                <%@ page import="java.util.List" %>
                    ...
                    <% List<LivreEntity> livres = (List<LivreEntity>) request.getAttribute("listLivre");
                            List<AdherentEntity> adherents = (List<AdherentEntity>)
                                    request.getAttribute("listAdherent");
                                    %>
                                    ...
                                    <head>
                                        ...
                                        <title>Créer un Prêt - Bibliothèque</title>
                                    ...
                                    <body>
                                        ...
                                        <nav class="navbar">
                                            <div class="nav-container">
                                                ...
                                                <ul class="nav-menu">
                                                    ...
                                                    <li><a href="creationAdherent" class="nav-link">Nouveau Adhérent</a>
                                                    </li>
                                        ...
                                        <div class="main-container">
                                            <div class="card">
                                                <h2>Création d'un nouveau Reservation</h2>
                                                    ...
                                                    <% } else if (request.getAttribute("messageSuccess") !=null) { %>
                                                        ...
                                                        <% } %>
                                                            ...
                                                            <form action="createReservation" method="post">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="idLivre">Livre à réserver</label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="dateReservation">Date du
                                                                        Reservation</label>
                                                                    <input type="date" id="dateReservation"
                                                                        name="dateReservation" class="form-control"
                                                                        required>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="dateMouvement">Date du Mouvement</label>
                                                                    <input type="date" id="dateMouvement"
                                                                        name="dateMouvement" class="form-control"
                                                                        required>
                                                                </div>
