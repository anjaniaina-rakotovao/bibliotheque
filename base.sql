...
ALTER TABLE livre
ADD COLUMN titre VARCHAR(255) NOT NULL;
...
ALTER TABLE prolongementPret
ADD COLUMN status VARCHAR(255) NOT NULL;

ALTER TABLE prolongementPret
ADD COLUMN dateProlongement DATE NOT NULL;
...
CREATE TABLE 
    historiqueReservation (
        idHistoriqueReservation INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
