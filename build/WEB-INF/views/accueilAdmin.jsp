        ...
        <div class="main-container">
            <div class="card">
                ...
                <div class="nav-links-old">
                    <a href="creationAdherent" class="nav-link">Nouveau Adhérent</a>
                    <a href="prolongementAdmin" class="nav-link">Confirmer un
                            prolongement</a>
                    <a href="ReservationAdmin" class="nav-link">Confirmer un reservation</a>
                </div>
            </div>
        </div>
    </body>
