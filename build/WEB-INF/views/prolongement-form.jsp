                ...
                <%@ page import="java.time.LocalDate" %>
                    ...
                    <% List<AdherentEntity> adherents = (List<AdherentEntity>) request.getAttribute("listAdherent");
                            List<PretEntity> prets = (List<PretEntity>) request.getAttribute("pretsEnCours");
                                    Map<Integer, LocalDate> datesFin = (Map<Integer, LocalDate>)
                                            request.getAttribute("datesFinPret");
                                                ...
                                                <nav class="navbar">
                                                    <div class="nav-container">
                                                        ...
                                                        <ul class="nav-menu">
                                                            ...
                                                            <li><a href="creationAdherent" class="nav-link">Nouveau
                                                                    Adhérent</a></li>
                                                            <li><a href="listelivre" class="nav-link">Liste des
                                                                    Livres</a></li>
                                                                ...
                                                                <% } %>
                                                                    ...
                                                                    <form action="prolongement" method="post"
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="idAdherent"
                                                                                ...
                                                                                <% for (AdherentEntity a : adherents) {
                                                                                    %>
                                                                                    <option
                                                                                        value="<%= a.getIdAdherent() %>"
                                                                                        <%=(idSel!=null &&
                                                                                        idSel.equals(a.getIdAdherent()))
                                                                                        ? "selected" : "" %>>
                                                                                        <%= a.getAdherentName() %>
                                                                                    </option>
                                                                                    <% } %>
                                                                        ...
                                                                        <button class="btn btn-primary"
                                                                            type="submit">Afficher prêts</button>
                                                                    </form>
                                                    </div>
                                                            ...
                                                            <form action="confirmerProlongement" method="post">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="idPret" class="form-control" required>
                                                                        <% for (PretEntity p : prets) { LocalDate
                                                                            fin=datesFin.get(p.getIdPret()); %>
